...
class Hangman extends Component {
	...
	constructor(props) {
		super(props);
		this.state = { nWrong: 0, guessed: new Set(), answer: this.getNewWord() };
	...
	render() {
		...
		return (
			<div className="Hangman">
				...
				<h3>
					Wrong Guesses: {this.state.nWrong} out of {this.props.maxWrong}!
				</h3>
				<div>
					<p className="Hangman-word">{!gameOver ? this.guessedWord() : this.state.answer}</p>
					<p className="Hangman-btns">{!gameOver ? this.generateButtons() : `Game Over! He Dies!!`}</p>
				</div>
