...
export const createTicker = (ticker) => {
	...
	return axios.post(url, { headers: { 'Content-Type': 'application/json' } }, { params: { ticker: ticker } });
};
...
export const editTicker = (id, ticker) =>
	axios.patch(url, { headers: { 'Content-Type': 'application/json' } }, { params: { id, ticker } });
